...
class FeeViewSet(ModelViewSet):
    ...
    def assign_student(self, request):
        """
        Assign or update fee for a single student.
        Body: {
            "student": 1,
            "term": "term1",
            "amount": 500,
            "book_user_fee": 50,   # optional
            "workbook_fee": 30,    # optional
            "arrears": 100,        # optional
        }
        """
    ...
    def bulk_assign(self, request):
        ...
        Body: {
            ...
            "term": "term1",
            "amount": 500,
            "book_user_fee": 50,   # optional - typically term1 only
            "workbook_fee": 30,    # optional - typically term1 only
        }
        Note: arrears are per-student so they are NOT set in bulk assign.
        """
        ...
        for student in students:
            ...
            if not is_new:
                # Preserve arrears and payments already recorded
                fee.amount        = amount
    ...
    def add_arrears(self, request, pk=None):
        """
        Add or update arrears for a student.
        Body: { "arrears": 200 }
        """
        fee     = self.get_object()
